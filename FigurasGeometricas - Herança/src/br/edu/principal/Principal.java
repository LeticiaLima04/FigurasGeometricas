...
public class Principal {
	...
	public static void main(String[] args) {
		...
		tri.calcArea();
		tri.mostrar_area();
		double recebe_area = tri.getArea();
